  ...
  particles: {
    ...
    shape: {
      ...
      stroke: {
        ...
        color: "#FFFFFF", //Color de borde en hexadecimal
      },
      polygon: {
        nb_sides: 5,
      },
      image: {
        //Si shape.type = image, mostrar la sig. imagen
    ...
    opacity: {
      value: 0.2, //Cantidad de opacidad. De 0 (transparente) a 1 (solido)
    ...
    line_linked: {
      ...
      color: "#000000", //Color en hexadecimal.
